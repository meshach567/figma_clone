...
const RightSidebar = ({
  ...
  // Memoize the handleInputChange function to avoid redefinition on every render
  const handleInputChange = useCallback(
    ...
    [fabricRef, activeObjectRef, setElementAttributes, syncShapeInStorage, isEditingRef]
  );
  ...
  const memoizedContent = useMemo(
    ...
    [elementAttributes, isEditingRef, handleInputChange] // Properly include dependencies
  );
